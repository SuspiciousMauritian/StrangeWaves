...
print('preprocessing ------------------------------------')
#automatic Bad data span rejection
...
filt_raw.plot_psd(fmax=70)
ica = mne.preprocessing.ICA(n_components=19, random_state=97, max_iter=1000)
ica.fit(filt_raw) 
ica.plot_sources(filt_raw, show_scrollbars=True, block = True)
ica.plot_components()
