...
count = 1
int_length_sec_count = int(length_sec)
while count < int_length_sec_count:
    second_mark = count * 500 
    time_stamp = count
    list_adition = [second_mark, 0, count]
    event_array_prenp.append(list_adition)
    count = count + 1
...
raw.plot(duration=10, n_channels=20, verbose = True, block = True, events = event_array, event_color = 'red', title = sample, theme = "dark", show_options = True)
